...
public class NetheriteKunaiItem extends SwordItem implements Vanishable {

    public static final float BASE_DAMAGE = 8.0F;

    public NetheriteKunaiItem(Tier toolMaterial, int attackDamage, float attackSpeed, Properties settings) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> components, @NotNull TooltipFlag flag) {
        ...
        components.add(Component.literal(" " + (float) (sharpnessLvl * 0.5 + 8) + " Ranged Damage").withStyle(ChatFormatting.DARK_GREEN));
