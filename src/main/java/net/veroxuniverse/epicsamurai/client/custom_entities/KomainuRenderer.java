    ...
    private static final Map<KomainuVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(KomainuVariant.class), map -> {
                map.put(KomainuVariant.DEFAULT,
                        new ResourceLocation(EpicSamuraiMod.MOD_ID, "textures/entity/komainu.png"));
                map.put(KomainuVariant.BLUE,
                        new ResourceLocation(EpicSamuraiMod.MOD_ID, "textures/entity/komainu_blue.png"));
                map.put(KomainuVariant.RED,
                        new ResourceLocation(EpicSamuraiMod.MOD_ID, "textures/entity/komainu_red.png"));
            });
