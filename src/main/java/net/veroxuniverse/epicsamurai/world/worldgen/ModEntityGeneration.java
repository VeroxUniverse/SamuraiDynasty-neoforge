...
public class ModEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToAllOverworldBiomes(event, ModEntityTypes.KITSUNE.get(),
                2, 1, 2);
        addEntityToAllBiomesNoNether(event, ModEntityTypes.ONI.get(),
                2, 1, 1);
        addEntityToAllBiomesNoNether(event, ModEntityTypes.AKANAME.get(),
                4, 2, 3);
        addEntityToAllOverworldBiomes(event, ModEntityTypes.ENENRA.get(),
                4, 2, 3);
    }
