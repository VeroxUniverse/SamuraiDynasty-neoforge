...
public class KitsuneProjectileEntity extends Projectile {
    ...
    public KitsuneProjectileEntity(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.noPhysics = true;
    }

    public KitsuneProjectileEntity(Level pLevel, LivingEntity pShooter, Entity pFinalTarget, Direction.Axis pAxis) {
        this(ModEntityTypes.KITSUNE_PROJECTILE.get(), pLevel);
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        if (flag) {
            ...
            if (entity instanceof LivingEntity) {
                ((LivingEntity)entity).addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1), MoreObjects.firstNonNull(entity1, this));
            }
        }
