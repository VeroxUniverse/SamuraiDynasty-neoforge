        ...
        if (livingentity != null && this.mob.distanceToSqr(livingentity) < 8.0D) {
            ...
            if (this.mob.distanceTo(livingentity) >= 8.0D) {
                if (this.attackTime <= 0) {
                    ...
                    KitsuneProjectileEntity kitsuneProjectileEntity = new KitsuneProjectileEntity(this.mob.level, this.mob, this.mob.getRandom().nextGaussian(d1, 2.297D * d4), d2, this.mob.getRandom().nextGaussian(d3, 2.297D * d4));
