...
public class SpiritWoodLeavesBlock extends LeavesBlock {
    public static final MapCodec<SpiritWoodLeavesBlock> CODEC = simpleCodec(SpiritWoodLeavesBlock::new);

    @Override
    public MapCodec<SpiritWoodLeavesBlock> codec() {
        return CODEC;
    }

    public SpiritWoodLeavesBlock(BlockBehaviour.Properties p_273704_) {
        super(p_273704_);
    }
    ...
    public void animateTick(BlockState p_272714_, Level p_272837_, BlockPos p_273218_, RandomSource p_273360_) {
        ...
        if (p_273360_.nextInt(10) == 0) {
            ...
            if (!isFaceFull(blockstate.getCollisionShape(p_272837_, blockpos), Direction.UP)) {
                ParticleUtils.spawnParticleBelow(p_272837_, p_273218_, p_273360_, ModParticles.SPIRIT_WOOD_LEAVES.get());
            }
        }
    }
}