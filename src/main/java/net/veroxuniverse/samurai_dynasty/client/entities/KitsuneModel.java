...
public class KitsuneModel extends GeoModel<KitsuneEntity> {
    ...
    public ResourceLocation getModelResource(KitsuneEntity object) {
        return new ResourceLocation(SamuraiDynastyMod.MOD_ID, "geo/kitsune.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(KitsuneEntity object) {
        return new ResourceLocation(SamuraiDynastyMod.MOD_ID, "textures/entity/kitsune.png");
    }

    @Override
    public ResourceLocation getAnimationResource(KitsuneEntity animatable) {
        return new ResourceLocation(SamuraiDynastyMod.MOD_ID, "animations/kitsune.animation.json");
    }
