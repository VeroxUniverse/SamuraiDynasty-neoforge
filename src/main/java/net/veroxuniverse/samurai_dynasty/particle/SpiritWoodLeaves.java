...
public class SpiritWoodLeaves extends TextureSheetParticle {
    ...
    protected SpiritWoodLeaves(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet pSpriteSet) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType particleType, @NotNull ClientLevel level,
            ...
            return new SpiritWoodLeaves(level, x, y, z, this.sprites);
        }
    }
}