...
public class TekkoKagiItem extends ESWeaponItem{

    public TekkoKagiItem(Tier tier, Properties properties) {
    ...
    public void createRenderer(Consumer<RenderProvider> consumer) {
        consumer.accept(new RenderProvider() {
            private TekkoKagiItemRenderer renderer = null;
            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null)
                    return new TekkoKagiItemRenderer();
